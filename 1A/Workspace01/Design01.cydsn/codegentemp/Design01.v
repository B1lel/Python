...
module UART_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("5634a257-51e3-4c02-a203-8ea01b90d8f1/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("285abbfd-8b62-468d-9582-53267e1d2933"),
    ...
    defparam Timer_2.Resolution = 24;
	...
	cy_psoc3_pins_v1_10
		#(.id("49344b15-fcea-444b-9c35-844403e6dfcf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a7530ecb-a6b4-4616-a36d-41b48fcbd92c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
